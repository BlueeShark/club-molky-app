    ...
    <main className="home-page-container">
      ...
      <section className="info-section">
        <div className="info-texte">
          <p>
            CRHOM 69 a pour but de promouvoir, développer et faire découvrir la
            pratique du Mölkky à travers des ateliers d’initiation, des
            rencontres amicales, des tournois et la participation à différents
            événements.
          </p>
          <p>
            Créée par des passionnés de ce jeu d’adresse convivial venu de
            Finlande, l’association souhaite rassembler les joueurs débutants
            comme confirmés autour d’un esprit de partage et de compétition
            saine.
          </p>
        </div>
      ...
      <section className="info-section reversed">
        <div className="info-texte">
          ...
          <p>
            Nous sommes l'équipe fondatrice du CRHOM, une bande de passionnés
            réunis par une vision commune : faire du Mölkky bien plus qu'un
            sport, mais un véritable vecteur de lien social à Lyon.
          </p>
          <p>
            Notre moteur collectif est de bâtir une communauté ouverte et
            bienveillante où le plaisir de jouer ensemble l'emporte sur l'enjeu
            de la victoire.
          </p>
        </div>
        <div className="info-image">
